...
export default function ProductDetailPage() {
  ...
  const hasDiscount = !!item && item.discountedPrice < item.price;

  return (
    <main className="relative min-h-[60vh] bg-white pb-12" aria-busy={loading}>
      <PageLoader active={loading} label="Loading product…" />
